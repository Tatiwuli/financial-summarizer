...
EARNINGS_LONG_Q_A_BULLET_PROMPT_VERSION = "version_1"
EARNINGS_SHORT_Q_A_BULLET_PROMPT_VERSION = "version_1"
EFFORT_LEVEL_Q_A = "minimal"

# CONFERENCE
CONFERENCE_Q_A_MODEL = "gpt-5"
CONFERENCE_LONG_Q_A_PROMPT_VERSION = "version_2"
CONFERENCE_LONG_Q_A_BULLET_PROMPT_VERSION = "version_1"
